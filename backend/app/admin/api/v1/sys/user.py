...
@router.get(
    "/{username}", summary="View user information", dependencies=[DependsJwtAuth]
)
...
@router.put(
    "/{username}", summary="Update user information", dependencies=[DependsJwtAuth]
)
...
@router.put(
    "/{username}/avatar", summary="Update avatar", dependencies=[DependsJwtAuth]
)
...
@router.put(
    "/{pk}/super", summary="Modify user super permissions", dependencies=[DependsRBAC]
)
...
@router.put(
    "/{pk}/staff",
    summary="Modify user background login permissions",
...
@router.put(
    "/{pk}/multi", summary="Modify user multi-login status", dependencies=[DependsRBAC]
)
